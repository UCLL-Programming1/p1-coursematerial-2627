...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["Alice", "X", "Bob", "O", "0", "3", "1", "4", "2"],
        # player 1 wins the left column
        ["Alice", "X", "Bob", "O", "0", "1", "3", "2", "6"],
        # player 2 wins on a diagonal
        ["Alice", "X", "Bob", "O", "1", "0", "2", "4", "5", "8"],
        # a full board with no winner: a draw
        ["Alice", "O", "Bob", "X", "0", "2", "1", "3", "5", "4", "6", "8", "7"],
        # player 1 wins with the very last free space: a win, not a draw
        ["Alice", "X", "Bob", "O", "0", "1", "2", "3", "4", "5", "7", "6", "8"],
        # invalid moves are rejected before player 1 wins
        ["Alice", "X", "Bob", "O", "9", "0", "3", "x", "1", "4", "2"],
    ]
)
